        ...
        ${state.compressedImage ? `
          <div class="preview">
            <div class="preview__item">
              ...
              <img class="preview__image" src="data:image/${state.originalImage.format};base64,${state.originalImage.buffer}" alt="Original">
            ...
            <div class="preview__item">
              ...
              <img class="preview__image" src="data:image/${state.compressedImage.format};base64,${state.compressedImage.buffer}" alt="Compressed">
              <div class="preview__stats">
